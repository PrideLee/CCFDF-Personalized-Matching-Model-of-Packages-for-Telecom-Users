...
dataframe_balance = pd.read_csv(r"/data/projects/CCFDF_18/data/class_2_sup_add_0_balance_sample.csv", encoding="utf-8",
                                low_memory=False)
...
id_error_dataframe.to_csv(r"/data/projects/CCFDF_18/result/GBDT/GBDT_error_id_0.csv", encoding="utf-8")
joblib.dump(BestModel, r"/data/projects/CCFDF_18/result/GBDT/best_GBDT_0.pkl")
train_score_dataframe = pd.DataFrame({"train_score": train_score})
train_score_dataframe.to_csv(r"/data/projects/CCFDF_18/result/GBDT/GBDT_train_score_0.csv", encoding="utf-8")
class_error_dataframe = pd.DataFrame({"class_error": class_error})
class_error_dataframe.to_csv(r"/data/projects/CCFDF_18/result/GBDT/GBDT_class_error_0.csv", encoding="utf-8")
importace_attributes_dataframe = pd.DataFrame({"importace_attributes": importace_attributes})
importace_attributes_dataframe.to_csv(r"/data/projects/CCFDF_18/result/GBDT/GBDT_importace_attributes_0.csv",
                                      encoding="utf-8")
attributes_score_dataframe = pd.DataFrame({"attributes_score": attributes_score})
attributes_score_dataframe.to_csv(r"/data/projects/CCFDF_18/result/GBDT/GBDT_attributes_score_0.csv", encoding="utf-8")
