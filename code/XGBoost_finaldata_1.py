...
if __name__ == '__main__':
    ...
    raw_data = pd.read_csv(r"E:\CCFDF\plansmatching\data\raw data\final_data\train1_final.csv",
    ...
    m_class = xgb.XGBClassifier(learning_rate=0.1, n_estimators=1500, max_depth=7, min_child_weight=6, gamma=0,
                                subsample=0.8, n_jobs=-1, colsample_bytree=0.8, objective='multi:softmax', num_class=3,
    ...
    #
    data_submit_raw = pd.read_csv(r"E:\CCFDF\plansmatching\data\raw data\final_data\test1_final.csv",
                                   encoding="utf-8", low_memory=False)
